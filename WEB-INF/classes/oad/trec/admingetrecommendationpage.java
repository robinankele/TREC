...
public class admingetrecommendationpage extends HttpServlet{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    writer.write("<html>\n");
    writer.write("<head>\n");
    writer.write("<title>Admin Get Recommendation Page</title>\n");
    ...
    writer.write("</form>\n");
    writer.write("<form action=\"getcustomers\" method=\"GET\">\n");
    writer.write("<table><tr><td valign=\"top\">\n");
    writer.write("<p style=\" font-size: 20;\">Recommendation for <i><b>Users </b></i>: </p><td><td><p><i>Choose a Hotel: </i></p>\n");
    try
    {
    ...
    writer.write("<select name=\"hotel\" size=\"5\">\n");
    try
    {
      ...
      if(sess.getValue("user") != null)
      {
          ...
          {
            String hotel_name = query_result.getString("hotel.name");
    ...
    writer.write("</select>\n");
    writer.write("<td valign=\"top\"><input style=\"margin-left: 0px\" type =\"submit\" value =\"Get Customers\"/></td>\n");
    writer.write("</td></tr></table></form>\n");
    writer.write("<form action=\"mainpage\" method=\"GET\">\n");
    writer.write("<input style=\"margin-left: 480px\" type =\"submit\" value =\"back\"/>\n");
    writer.write("</form>\n");
    writer.write("</fieldset>\n");
    writer.write("</div>\n");
